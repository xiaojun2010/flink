...
public class PatternStream<T> {
    ...
    PatternStream(final DataStream<T> inputStream, final DynamicPattern<T> dynamicPattern) {
        this(PatternStreamBuilder.imoocForStreamAndPattern(inputStream, dynamicPattern));
    }
    ...
    public PatternStream<T> inProcessingTimeImooc() {
        return new PatternStream<>(builder.inProcessingTimeImooc());
    }
    ...
    public PatternStream<T> inEventTimeImooc() {
        return new PatternStream<>(builder.inEventTimeImooc());
    }
